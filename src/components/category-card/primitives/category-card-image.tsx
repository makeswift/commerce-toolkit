...
export function CategoryCardImage({
  ...
  return (
    <Component
      className={cn(
        'h-full w-full scale-100 select-none bg-[var(--category-card-light-background,hsl(var(--contrast-100)))] object-cover transition-transform duration-500 ease-out',
        // Group hover state
