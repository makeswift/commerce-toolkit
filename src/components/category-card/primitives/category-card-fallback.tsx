...
export function CategoryCardFallback({ className, children, ...props }: CategoryCardFallbackProps) {
  return (
    <div
      className={cn(
        'break-words p-4 text-4xl font-bold leading-none tracking-tight transition-transform duration-500 ease-out [color:color-mix(in_oklab,hsl(var(--foreground))_30%,transparent)]',
        // Group hover state
