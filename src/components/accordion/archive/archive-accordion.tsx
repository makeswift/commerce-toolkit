...
function AccordionItem({
  ...
  return (
    <AccordionPrimitive.Item
      {...props}
      className={clsx(
        'has-[:focus-visible]:ring-(--accordion-focus,var(--primary)) focus:outline-2 has-[:focus-visible]:ring-2 has-[:focus-visible]:ring-offset-4',
        {
    ...
    >
      <AccordionPrimitive.Header>
        <AccordionPrimitive.Trigger className="focus:outline-hidden group flex w-full cursor-pointer items-start gap-8 border-none py-3 text-start @md:py-4">
          <div
            className={clsx(
              'font-(family-name:--accordion-title-font-family,var(--font-family-mono)) flex-1 select-none text-sm font-normal uppercase transition-colors duration-300 ease-out',
              {
                light:
      ...
      >
        <div
          className={clsx(
            'font-(family-name:--accordion-content-font-family,var(--font-family-body)) py-3 text-base font-light leading-normal',
            {
