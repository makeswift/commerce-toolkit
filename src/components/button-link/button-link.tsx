...
export interface ButtonLinkProps extends ComponentPropsWithoutRef<'a'> {
  ...
  render?: (props: ComponentPropsWithoutRef<'a'> & { children: ReactNode }) => ReactNode;
}
...
export function ButtonLink({
  ...
  const renderLink = () => {
    ...
    return (
      <a {...props} className={computedClassName}>
        {computedChildren}
      </a>
    );
  };
