...
export function AnimatedUnderline({ className, children, ...props }: AnimatedUnderlineProps) {
  return (
    <span
      className={cn(
        'origin-left font-semibold leading-normal text-[var(--animated-underline-text,var(--foreground))] transition-[background-size] duration-300 [background:linear-gradient(0deg,var(--animated-underline-hover,var(--primary)),var(--animated-underline-hover,var(--primary)))_no-repeat_left_bottom_/_0_2px] [font-family:var(--animated-underline-font-family,var(--font-family-body))] hover:bg-[size:100%_2px] group-focus/underline:bg-[size:100%_2px]',
        className,
      )}
      {...props}
    >
