  ...
  return (
    <SelectPrimitive.Item
      className={cn(
        ...
        'px-3 py-2',
        // Typography
        'text-sm font-normal text-[var(--select-light-item-text,hsl(var(--contrast-400)))]',
        // Borders & Rounded
        'rounded-lg',
        // Effects
        'outline-none',
        ...
        'transition-colors',
        // Hover state
        'hover:bg-[var(--select-light-item-background-hover,hsl(var(--contrast-100)))] hover:text-[var(--select-light-item-text-hover,hsl(var(--foreground)))]',
        // Focus-visible state
