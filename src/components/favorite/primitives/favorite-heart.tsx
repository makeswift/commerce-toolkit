...
export function FavoriteHeart({ filled = false, className, ...props }: FavoriteHeartProps) {
  return (
    <svg
      className={cn(
    ...
    >
      ...
      <path
        className={cn({
          '-translate-x-px -translate-y-px scale-110 opacity-0 transition delay-100': filled,
        })}
